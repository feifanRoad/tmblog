...
<link rel="stylesheet" href="${basePath}/resources/font/css/font-awesome.min.css"/>
...
<script type="text/javascript" src="${basePath}/resources/js/ckeditor/ckeditor.js"></script>
